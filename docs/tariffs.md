...
| **Pro** *(хит, ≈2000)* | **1 990 ₽** | **19 900 ₽** (1 658/мес) | 20 | 800 | `*.nelvi.app` | ✅ (5 доменов) | ZIP + S3 + WP | Приоритет очереди, canvas без лимита, удаление бренда, A/B правки чатом |
...
- При 100 платящих Pro: **183 тыс. ₽ MRR** чистыми, 1 000 — 1.83 млн.
