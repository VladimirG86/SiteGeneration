...
def build_site(answers: dict, theme_mode: str, accent: str) -> dict:
    ...
    _REVIEWS_TEMPLATES = {
        ...
        "it": [
            ("Аня, коуч{city}", "QR-визитка{city}, июль 2026", "Собрала за вечер без дизайнера — блоки, оплата, QR. Заявки сразу в Telegram."),
            ("Игорь, товары{city}", "Лендинг{city}, март 2026", "Импортировал старый сайт по ссылке, поправил чатом «тёмную тему» — готово."),
            ("Мария, услуги{city}", "Канвас{city}, август 2026", "Свободный как в Tilda: drag-resize, публикация в 1 клик, SSL автоматом."),
        ],
        "generic": [
    ...
    _FAQ = {
        ...
        "it": [
            {"q": "Нужен ли код или дизайнер?", "a": "Нет — собираешь блоками, как в Tilda. Импортируй сайт по ссылке или правь чатом «сделай тёмную тему»."},
            {"q": "Как публиковать?", "a": "В 1 клик — поддомен *.nelvi.app и SSL автоматом. Свой домен — в Pro."},
            {"q": "Что с заявками?", "a": "Все формы — в админке и Telegram. Экспорт CSV, вебхуки — в Business."},
            {"q": "Можно забрать сайт?", "a": "Да — экспорт ZIP в 1 клик, или публикация в S3/WP. Сайт — один файл."},
        ],
    }
    generic_faq = [
    ...
    _HERO_CTA = {
        ...
        "it": ("Создать сайт →", "Смотреть тарифы"),
