...
def build_site(answers: dict, theme_mode: str, accent: str) -> dict:
    ...
    _ABOUT_P2 = {
        ...
        "it": "Считаем фиксированную смету по спринтам и отчитываемся в кабинете.",
    ...
    _PROCESS = {
        ...
        "it": [
            {"title": "Бриф", "desc": "Собираем задачу и KPI — старт за 5 дней."},
            {"title": "План", "desc": "Планируем спринты и считаем фиксированную смету."},
            {"title": "Запуск", "desc": "Запускаем и ведём отчётность в кабинете."},
            {"title": "Рост", "desc": "Масштабируем то, что сработало."},
        ],
    }
