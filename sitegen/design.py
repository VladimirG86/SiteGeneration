...
def build_css(mode: str, accent: str) -> str:
    ...
    *{{margin:0;padding:0;box-sizing:border-box}}
    ...
    .stat{{background:var(--surface);border:1px solid var(--border);border-left:3px solid var(--accent);border-radius:16px;padding:18px 20px;box-shadow:var(--shadow)}}
    .stat b{{display:block;font-family:'Unbounded',sans-serif;font-size:26px;letter-spacing:-.03em;color:var(--accent);line-height:1}}
    .stat span{{font-size:13px;color:var(--muted);font-family:'Inter',sans-serif;display:block;margin-top:4px}}
